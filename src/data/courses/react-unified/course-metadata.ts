  ...
  modules: [
    ...
    },
    {
      ...
      projects: [
        {
          id: 'project-1-3',
          name: 'Interactive Button Suite',
          description: 'Build various interactive buttons with event handlers',
          xp: 150,
          successCriteria: ['Multiple event types', 'Event delegation', 'Proper event handling'],
          timeEstimate: '2-3 hours'
        }
      ],
      challenges: [
    ...
    },
    {
      ...
      projects: [
        {
          id: 'project-1-4',
          name: 'Dynamic Content Display',
          description: 'Build UI that changes based on conditions',
          xp: 150,
          successCriteria: ['Multiple conditional patterns', 'Loading states', 'Error handling'],
          timeEstimate: '2-3 hours'
        }
      ],
      challenges: [
    ...
    },
    {
      ...
      projects: [
        {
          id: 'project-1-5',
          name: 'Dynamic List Manager',
          description: 'Build a list component with add/remove/filter',
          xp: 150,
          successCriteria: ['Proper key usage', 'Dynamic updates', 'List manipulation'],
          timeEstimate: '2-3 hours'
        }
      ],
      challenges: [
  ...
  modules: [
    {
      ...
      projects: [
        {
          id: 'project-2-1',
          name: 'Theme System with Context',
          description: 'Build a complete theme switching system',
          xp: 200,
          successCriteria: ['useContext implementation', 'Theme persistence', 'Custom hooks'],
          timeEstimate: '2-3 hours'
        }
      ],
      challenges: [
      ...
      projects: [
        {
          ...
          xp: 200,
          successCriteria: ['Multiple patterns', 'Reusable components', 'Clean API design'],
          timeEstimate: '2-3 hours'
        }
      ],
      challenges: [
      ...
      projects: [
        {
          ...
          xp: 200,
          successCriteria: ['Memoization', 'Code splitting', 'Performance metrics'],
          timeEstimate: '2-3 hours'
        }
      ],
      challenges: [
      ...
      projects: [
        {
          ...
          xp: 200,
          successCriteria: ['Multiple routes', 'Dynamic parameters', 'Protected routes'],
          timeEstimate: '2-3 hours'
        }
      ],
      challenges: [
      ...
      projects: [
        {
          ...
          xp: 250,
          successCriteria: ['Redux Toolkit', 'Async actions', 'Normalized state'],
      ...
      projects: [
        {
          ...
          xp: 250,
          successCriteria: ['All components typed', 'Generic components', 'Zero type errors'],
          timeEstimate: '4-6 hours'
        }
      ],
      challenges: [
      ...
      projects: [
        {
          ...
          xp: 250,
          successCriteria: ['80%+ coverage', 'Unit + integration tests', 'E2E tests'],
          timeEstimate: '4-6 hours'
        }
      ],
      challenges: [
      ...
      projects: [
        {
          ...
          xp: 250,
          successCriteria: ['Error handling', 'Suspense', 'React 19 features', 'Production deployment'],
          timeEstimate: '4-6 hours'
        }
      ],
      challenges: [
